...
<html lang="en">
   <head>
      ...
      <!-- Link's Adding -->
	<title>Add New 50 Millions Post</title>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="full">
					 ...
					 <form method="post" action="post50.php" enctype="multipart/form-data">
					 <h2>Add New 50 Millions House Detail</h2>
...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$query = "INSERT INTO post50 (number,title,description,image) VALUES('$num','$titl','$desc','$name')";
